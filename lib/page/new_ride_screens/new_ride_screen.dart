...
import 'package:citgroupvn_car/controller/new_ride_controller.dart';
import 'package:citgroupvn_car/model/ride_model.dart';
import 'package:citgroupvn_car/page/complaint/add_complaint_screen.dart';
import 'package:citgroupvn_car/page/completed_ride_screens/trip_history_screen.dart';
import 'package:citgroupvn_car/page/review_screens/add_review_screen.dart';
import 'package:citgroupvn_car/page/route_view_screen/route_view_screen.dart';
    ...
    return InkWell(
      onTap: () async {
        if (data.statut == "completed") {
          ...
          if (["inappmap", "google"].contains(Constant.mapType)) {
                  ...
                  children: [
                    Row(
                      ...
                      children: [
                        ...
                        Expanded(
                          child: Text(
                            data.departName?.toString() ?? "No update location".tr,
                            maxLines: 2,
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        Expanded(
                          child: Text(
                            Constant().getDestinationText(data.destinationName.toString()),
                            maxLines: 2,
                            overflow: TextOverflow.ellipsis,
                          ),
                        ),
                                      ...
                                      children: [
                                        ...
                                        Padding(
                                          ...
                                          child: TextScroll(
                                            ...
                                            "${(data.distanceUnit?.isNotEmpty == true) ? data.distanceUnit : "Km"}",
                          ...
                          Column(
                            ...
                            children: [
                              ...
                              Padding(
                                ...
                                child: Text(Constant().formatDate(data.dateRetour.toString()),
                                    style: const TextStyle(
