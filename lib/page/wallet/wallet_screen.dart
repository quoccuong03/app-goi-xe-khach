...
import 'package:citgroupvn_car/model/get_payment_txt_token_model.dart';
import 'package:citgroupvn_car/model/payStackURLModel.dart';
import 'package:citgroupvn_car/model/razorpay_gen_orderid_model.dart';
import 'package:citgroupvn_car/model/stripe_failed_model.dart';
import 'package:citgroupvn_car/model/transaction_model.dart';
import 'package:citgroupvn_car/page/wallet/payStackScreen.dart';
import 'package:citgroupvn_car/page/wallet/pay_9_web_view_screen.dart';
              ...
              Expanded(
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      Text(
                        Constant().formatDate(data.creer.toString()),
                        style: const TextStyle(
                  ...
                  children: [
                    SizedBox(
                      ...
                      child: Text(
                        ...
                        //     : "(${"-${Constant().amountShow(amount: data.amount.toString())}"})",
                        Constant().amountShow(
                            amount: data.amount.toString(), showPrefix: true),
                        textAlign: TextAlign.end,
                        style: TextStyle(
                            fontWeight: FontWeight.w600,
                            color: Constant()
                                    .isNegativeAmount(data.amount.toString())
                                ? Colors.red
                                : Colors.green,
                            fontSize: 16),
                      ),
                                ...
                                SizedBox(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      Text(
                                        Constant()
                                            .formatDate(data.creer.toString()),
                                        style: const TextStyle(
                                          fontWeight: FontWeight.w500,
                                          fontSize: 16,
                                        ),
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      Text(
                                        ...
                                        style: TextStyle(
                                          fontWeight: FontWeight.w600,
                                          color: Constant().isNegativeAmount(
                                ...
                                children: [
                                  ...
                                  Row(
                                    ...
                                    children: [
                                      ...
                                      Text(
                                        data.paymentMethod!.tr.toUpperCase(),
                                        style: TextStyle(
                                          fontWeight: FontWeight.w600,
                                          color: ConstantColors.primary,
                                          fontSize: 16,
                    ...
                    child: InkWell(
                      ...
                      child: Column(
                        children: [
                          ...
                          /// Currently, we will use 9pay payment methods instead of the old methods
                          Visibility(
                            visible: true,
                            child: Padding(
                              padding: const EdgeInsets.symmetric(
                              ...
                              child: Card(
                                ...
                                elevation: walletController.pay9.value ? 0 : 2,
                                child: RadioListTile(
                                  shape: RoundedRectangleBorder(
                                      borderRadius: BorderRadius.circular(8),
                                      side: BorderSide(
                                          color: walletController.pay9.value
                                  ...
                                  onChanged: (String? value) {
                                    walletController.pay9 = true.obs;
                                    walletController.selectedRadioTile!.value =
                                        value!;
                                  },
                                  selected: walletController.pay9.value,
...
/*                          controller.isLoading.value
  ...
  Future<void> start9PayPayment({required String amount}) async {
    try {
      walletController
          .create9PayTransaction(amount: amount)
          .then((jsonResponse) async {
        if (jsonResponse != null) {
          if (jsonResponse['success'] == "Failed") {
            Get.back();
            showSnackBarAlert(
            ...
            Get.back();
            var url = jsonResponse['data']['payment_url'];
            await Get.to(() => Pay9WebViewScreen(
                  url: url,
                ));
            walletController.getAmount();
            walletController.getTransaction();
