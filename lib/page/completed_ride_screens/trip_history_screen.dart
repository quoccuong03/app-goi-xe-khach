...
import 'package:citgroupvn_car/controller/payment_controller.dart';
                        ...
                        children: [
                          ...
                          Row(
                            ...
                            children: [
                              ...
                              Expanded(
                                child: Text(
                                  Constant().getDestinationText(controller.data.value.destinationName
                                      .toString()),
                                  maxLines: 2,
                                  overflow: TextOverflow.ellipsis,
                                ),
                                            ...
                                            children: [
                                              ...
                                              Padding(
                                                padding: const EdgeInsets.only(
                                                    top: 8.0),
                                                child: Text(
                                                    "${double.parse(controller.data.value.distance.toString())} "
                                                    "${(controller.data.value.distanceUnit?.isNotEmpty == true) ? controller.data.value.distanceUnit : "Km"}",
                                                    //DateFormat('\$ KK:mm a, dd MMM yyyy').format(date),
                                                    style: const TextStyle(
                                                        fontWeight:
                                                            FontWeight.w800,
                              ...
                              children: [
                                Expanded(
                                  child: InkWell(
                                    onTap: () {
                                      // show info driver
                                      _showDriverInfoScreen(
                                          context, controller.data.value);
                                    },
                                    child: Row(
                                      children: [
                                        ClipRRect(
                                ...
                                Column(
                                  ...
                                  children: [
                                    ...
                                    Padding(
                                      ...
                                      child: Text(
                                          Constant().formatDate(controller
                                              .data.value.dateRetour
                                              .toString()),
                                          style: const TextStyle(
