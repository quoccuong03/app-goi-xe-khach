...
import 'package:citgroupvn_car/model/ride_details_model.dart';
...
class PaymentController extends GetxController {
  ...
  Future<dynamic> walletDebitAmountRequest(
    ...
    try {
      ...
      final response = await client.post(Uri.parse(API.payRequestWallet),
  ...
  Future<dynamic> cashPaymentRequest(Map<String, dynamic> bodyParams) async {
    try {
      ShowToastDialog.showLoader("Vui lòng đợi");
      final response = await client.post(Uri.parse(API.payRequestCash),
          headers: API.header, body: jsonEncode(bodyParams));
  ...
  Future<dynamic> transactionAmountRequest() async {
    ...
    try {
      ShowToastDialog.showLoader("Vui lòng đợi");
      final response = await client.post(Uri.parse(API.payRequestTransaction),
          headers: API.header, body: jsonEncode(bodyParams));
      Map<String, dynamic> responseBody = json.decode(response.body);
