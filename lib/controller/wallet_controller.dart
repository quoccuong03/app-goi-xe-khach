...
class WalletController extends GetxController {
  ...
  @Deprecated('Use 9pay payment methods instead of the old methods')
  ...
  Future<dynamic> setAmount(String amount) async {
    try {
      ...
      final response = await client.post(Uri.parse(API.amount),
  ...
  create9PayTransaction({required String amount}) async {
    try {
