...
import 'package:citgroupvn_car/controller/settings_controller.dart';
import 'package:citgroupvn_car/model/ride_model.dart';
import 'package:citgroupvn_car/page/auth_screens/login_screen.dart';
import 'package:citgroupvn_car/page/localization_screens/localization_screen.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    Future.delayed(const Duration(seconds: 3), () {
      LocalizationService().changeLocale('vn');
    });
    ...
    return GetMaterialApp(
      ...
      home: GetBuilder(
          ...
          builder: (controller) {
            return Preferences.getBoolean(Preferences.isFinishOnBoardingKey)
